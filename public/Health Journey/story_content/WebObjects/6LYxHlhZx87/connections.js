class ConnectionsGame {
  constructor() {
    ...
    this.words = [
      ...
      'HomeCare Direct',
      'Elevate Medical Group',
    ];

    this.validGroups = [
      ['Medicare', 'Medicaid', 'Individual and Family Plans', 'Plan Members'], // Customers VitaWorks Serves
      [
        'Regulation',
        'Public Sentiment',
        'Population Trends',
        'Workforce Trends',
      ], // Market Factors That Influence VitaWorks
      ['Individual Members', 'Payors', 'Health Systems', 'Primary Care'], // Stakeholders VitaWorks Serves
      ['Chronic Care Program', 'Meridian Health Partners', 'HomeCare Direct', 'Elevate Medical Group'], // Competitors
    ];

    this.groupLinks = [
      {
        title: 'Customers VitaWorks Serves',
        description: [
          'Medicare',
          'Medicaid',
          'Individual and Family Plans',
      ...
      {
        title: 'Market Factors That Influence VitaWorks',
        description: [
          'Regulation',
          'Public Sentiment',
          'Population Trends',
      ...
      {
        title: 'Stakeholders VitaWorks Serves',
        description: [
          'Individual Members',
          'Payors',
          'Health Systems',
